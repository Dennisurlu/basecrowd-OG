...
export class CookieConsentPage extends React.Component {
  ...
  */
  ...
  render() {
    ...
    return (
      <div style={{padding:26, paddingTop:60, maxWidth:760}}>
        <Typography variant="title">Cookie- og Privatlivspolitik </Typography>
